...
* Sim_Afix - dimensões da cachoeira (<code>area</code>) fixa em 50.
* Sim2_Avar - dimensões da cachoeira (<code>area</code>) sorteada de uma distribuição uniforme entre 10 e 100 (arredondada para números inteiros).
