...
>>>>>>> 267d26bb8dd5ebb763cefe2666f3d583f78b8241
<details>
...
### GLMM x GLM (EDITAR: VER SE É NECESSÁRIO TESTAR GLMs)
...
```{r}
glmmP = glmer(ttot~prob + (1|nsim), family = Gamma(link = "log"), data=sim_Avar)

#Comparando o glmm com o glm:
glmP = glm(ttot~prob, family = Gamma(link = "log"), data=sim_Avar)
