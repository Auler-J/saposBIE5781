...
result = data.frame(nmacho = NA, dcach = NA, prob = NA, foot = NA, freq = NA, tama = NA, distf = NA, ttot = NA, nsim = NA, femea = NA)
storepos = list(NA)
...
for(k in 1:nsim){
  ...
  dados = data.frame(nmacho = paste0("m", 1:nmacho), dcach = NA, prob = NA, foot = NA, freq = NA, tama = NA, distf = NA, ttot = NA, nsim = NA)
