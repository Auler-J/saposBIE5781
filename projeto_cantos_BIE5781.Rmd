...
plot(result$ttot ~ result$foot)
plot(result$ttot ~ result$freq)
plot(result$ttot ~ result$tama)

# Modelos
glmer(ttot~tama + (1|nsim), family = Gamma, data=result)
glmer(ttot~foot + (1|nsim), family = Gamma, data=result)
glmer(ttot~freq + (1|nsim), family = Gamma, data=result)
glmer(ttot~log(tama)+log(freq)+log(foot) + (1|nsim), family = Gamma, data=result)
glm(ttot~log(tama)+log(freq)+log(foot), family = Gamma, data=result)
```
